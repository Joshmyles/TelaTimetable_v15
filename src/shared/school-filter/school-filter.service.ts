...
import {
  ...
  DbTimetable,
  NewDbTimetable,
} from 'src/app/sidenav/timetable/timetable.dto';
...
export class SchoolFilterService {
  ...
  getRegions(params: HttpParams): Observable<ResponseDto<Region[]>> {
    return this._http
      .get<ResponseDto<Region[]>>(`${environment.BASE_URL}/regions/filter`, {
        params,
      })
      .pipe(retry(3));
  }
  ...
  getAllAcademicYears(): Observable<ResponseDto<AcademicYear[]>> {
    return this._http
      .get<ResponseDto<AcademicYear[]>>(`${environment.BASE_URL}/academicYears`)
      .pipe(retry(3));
  }

  getAcademicTerms(
    params: HttpParams
  ): Observable<ResponseDto<AcademicTerm[]>> {
    ...
    return this._http.get<ResponseDto<AcademicTerm[]>>(
      `${environment.BASE_URL}/academicTerms/filter`,
      { params: params }
    );
  }
  ...
  getDistricts(params: HttpParams): Observable<ResponseDto<District[]>> {
    return this._http
      .get<ResponseDto<District[]>>(
        `${environment.BASE_URL}/districts/filter`,
        { params }
      )
      .pipe(retry(3));
  }
  ...
  getSchools(params: HttpParams): Observable<ResponseDto<School[]>> {
    return this._http
      .get<ResponseDto<School[]>>(`${environment.BASE_URL}/schools/filter`, {
        params,
      })
      .pipe(retry(3));
  }
  ...
  getSchoolClasses(params: HttpParams): Observable<ResponseDto<School[]>> {
    return this._http
      .get<ResponseDto<School[]>>(
        `${environment.BASE_URL}/schoolClasses/filter`,
        { params }
      )
      .pipe(retry(3));
  }
  ...
  getAllSubjects(params: HttpParams): Observable<ResponseDto<SchoolSubject[]>> {
    return this._http
      .get<ResponseDto<SchoolSubject[]>>(
        `${environment.BASE_URL}/subjects/filter`,
        { params }
      )
      .pipe(retry(3));
  }
  ...
  searchStaff(
    params: HttpParams
  ): Observable<ResponseDto<SchoolStaffWithSchool_DistrictDto[]>> {
    return this._http
      .get<ResponseDto<SchoolStaffWithSchool_DistrictDto[]>>(
        `${environment.BASE_URL}/schoolStaffs/filter2`,
        { params: params }
      )
      .pipe(retry(3));
  }
  ...
  uploadTimetable(
    ...
    return this._http
      .post<ResponseDto<string>>(
        `${environment.BASE_URL}/timetable2`,
        schoolTimeTable
      )
      .pipe(retry(3));
  }

  updateSchoolClassTimetable(
    params: HttpParams,
    dbTimetableLesson: DbTimetableLesson[]
  ) {
    return this._http
      .put<ResponseDto<DbTimetable>>(
        `${environment.BASE_URL}/timetable2`,
        dbTimetableLesson,
        { params }
      )
  ...
  loadTimetable(params: HttpParams): Observable<ResponseDto<DbTimetable>> {
    return this._http
      .get<ResponseDto<DbTimetable>>(`${environment.BASE_URL}/timetable2`, {
        params,
      })
      .pipe(retry(3));
  }
  ...
  saveUpdateClassTimetable(
    ...
    return this._http
      .post<ResponseDto<string>>(
        `${environment.BASE_URL}/saveUpdateClassTimetable`,
        tt
      )
      .pipe(retry(3));
  }
